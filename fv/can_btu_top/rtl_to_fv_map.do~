...
# Generated on: Wed Mar 11 20:18:04 -03 2026 (Wed Mar 11 23:18:04 UTC 2026)
...
set logfile fv/can_btu_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/can_btu_top -revised fv_map
...
add_search_path /pdk/gpdk045/gsclib045_svt_v4.7/gsclib045/timing /pdk/gpdk045/gsclib045_svt_v4.7/gsclib045/lef -library -both
read_library -liberty -both \
    /pdk/gpdk045/gsclib045_svt_v4.7/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
add_search_path /prj/ci/workarea/aluno20/BTU -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 /prj/ci/workarea/aluno20/BTU/can_btu_top.sv
elaborate_design -golden -root {can_btu_top} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/can_btu_top/fv_map.v.gz
elaborate_design -revised -root {can_btu_top}
...
#add_name_alias fv/can_btu_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.can_btu_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.can_btu_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.can_btu_top.rtl.fv_map.rpt
