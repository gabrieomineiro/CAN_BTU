...
var nested2 = null;
	...
	//	,	south__spacing_closed:		20		// big resizer-bar when open (zero height)
        ,	south__minSize:	100
  		,	south__size:			.3	// 'fast' animation when resizing west-pane
...
//		,	east__maxSize:				.5 // 50% of layout width
        ...
        ,   north__size:			200	// 'fast' animation when resizing west-pane
  		,	south__size:			300	// 'fast' animation when resizing west-pane
	    ...
	    myLayout.sizePane("north", 145);
       	...
       	//	,	south__spacing_closed:		20		// big resizer-bar when open (zero height)
               ,	south__minSize:	100
         		,	south__size:			.2	// 'fast' animation when resizing west-pane
